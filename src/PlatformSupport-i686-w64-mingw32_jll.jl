module PlatformSupport-i686-w64-mingw32_jll
...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import PlatformSupport-i686-w64-mingw32_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("2a05b633-e323-5146-b484-31a1a89d84f7"))
platforms = [Pkg.Artifacts.unpack_platform(e, "PlatformSupport-i686-w64-mingw32", artifacts_toml) for e in artifacts["PlatformSupport-i686-w64-mingw32"]]
...
if best_platform === nothing
    @debug("Unable to load PlatformSupport-i686-w64-mingw32; unsupported platform $(triplet(platform_key_abi()))")
else
    # Load the appropriate wrapper
    include(joinpath(@__DIR__, "wrappers", "$(best_platform).jl"))
end

end  # module PlatformSupport-i686-w64-mingw32_jll
